...
public class StudentManagement {
    ...
    static void updateStudent() {
        ...
        for (Student s : students) {
            if (s.id == id) {
                System.out.print("Enter new Name   : "); s.name   = sc.nextLine().trim();
                System.out.print("Enter new Course : "); s.course = sc.nextLine().trim();
                System.out.print("Enter new Marks  : "); s.marks  = sc.nextLine().trim();
